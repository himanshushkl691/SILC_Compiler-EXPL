...
{
  "$end", "error", "$undefined", "NUM", "PLUS", "MINUS", "DIV", "MUL",
  "END", "'('", "')'", "$accept", "start", "expr", YY_NULLPTR
};
#endif
...
#line 1248 "y.tab.c" /* yacc.c:1646  */
  ...
  case 6:
#line 29 "exptree.y" /* yacc.c:1646  */
    {(yyval.node) = makeOperatorNode('/',(yyvsp[-2].node),(yyvsp[0].node));}
#line 1254 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 30 "exptree.y" /* yacc.c:1646  */
    {(yyval.node) = (yyvsp[-1].node);}
#line 1260 "y.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 31 "exptree.y" /* yacc.c:1646  */
    {(yyval.node) = (yyvsp[0].node);}
